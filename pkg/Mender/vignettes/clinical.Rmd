---
title: "Mender: CLL Clinical Data"
...
output: 
  rmarkdown::html_vignette:
    toc: true
vignette: >
  %\VignetteIndexEntry{Mender: CLL Clinical Data}
...
```{r recycle}
poof <- angleMeans(W, ripdiag, cyc1@index, clinical)
poof[is.na(poof)] <- 0
...
angle.df <- poof[, c("CatWBC", "CatCD38", "Hypogammaglobulinemia", "Massive.Splenomegaly", 
                     "Matutes", "Prolymphocytes")]
