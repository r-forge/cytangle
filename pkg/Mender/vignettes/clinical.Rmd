...
vignette: >
  ...
  %\VignetteDepends{Mender,igraph,Polychrome,Mercator,ClassDiscovery,ape}
...
voidPlot(vd, mds)
voidFeatures(featMU, mds, radius = 0.011) # need to increase radius when you overlay one sphere on another
rgl::rglwidget()
